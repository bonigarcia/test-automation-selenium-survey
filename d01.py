...
# Filter columns
col_name = "Which generative AI tools do you use to support the development of Selenium scripts?"
...
ax.set_title("GenAI Tools by Perceived Importance")
ax.invert_yaxis()

# Save and show chart
plt.xlim(1, 5)
plt.savefig("d01.pdf", dpi=300, bbox_inches='tight', pad_inches=0) 
plt.tight_layout()
plt.show()