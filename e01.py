...
# Filter columns
col_name = "What alternative tools to Selenium and its ecosystem do you use for test automation?"
...
ax.set_title("Alternative Tools by Perceived Importance")
ax.invert_yaxis()

# Save and show chart
plt.xlim(1, 5)
plt.savefig("e01.pdf", dpi=300, bbox_inches='tight', pad_inches=0) 
plt.tight_layout()
plt.show()