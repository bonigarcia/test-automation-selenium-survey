...
# Filter columns
col_name = "For which aspects of software testing and test automation do you use some AI-powered tool?"
...
ax.set_title("Goals of Using AI by Perceived Importance")
ax.invert_yaxis()

# Save and show chart
plt.xlim(1, 5)
plt.savefig("d02.pdf", dpi=300, bbox_inches='tight', pad_inches=0) 
plt.tight_layout()
plt.show()