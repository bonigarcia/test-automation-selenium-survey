...
# Filter columns
col_name = "What potential problems do you see when using AI-assisted tools for test automation?"
...
ax.set_title("Problems of Using AI by Perceived Importance")
ax.invert_yaxis()

# Save and show chart
plt.xlim(1, 5)
plt.savefig("d04.pdf", dpi=300, bbox_inches='tight', pad_inches=0) 
plt.tight_layout()
plt.show()