...
# Filter columns
col_name = "Which design patterns do you use for developing Selenium scripts?"
...
ax.set_title("Design Patterns by Perceived Importance")
ax.invert_yaxis()

# Save and show chart
plt.xlim(1, 5)
plt.savefig("b09.pdf", dpi=300, bbox_inches='tight', pad_inches=0) 
plt.tight_layout()
plt.show()