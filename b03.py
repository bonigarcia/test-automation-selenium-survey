...
# Filter columns
col_name = "What type of browsers do you use for your Selenium scripts?"
...
ax.set_title("Browser Types by Perceived Importance")
ax.invert_yaxis()

# Save and show chart
plt.xlim(1, 5)
plt.savefig("b03.pdf", dpi=300, bbox_inches='tight', pad_inches=0) 
plt.tight_layout()
plt.show()