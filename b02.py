...
# Filter columns
col_name = "What do you use Selenium for?"
...
ax.set_title("Selenium Use Cases by Perceived Importance")
ax.invert_yaxis()

# Save and show chart
plt.xlim(1, 5)
plt.savefig("b02.pdf", dpi=300, bbox_inches='tight', pad_inches=0) 
plt.tight_layout()
plt.show()