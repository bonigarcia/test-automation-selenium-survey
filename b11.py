...
# Filter columns
col_name = "Which Behavior-Driven Development (BDD) framework do you use with Selenium?"
...
ax.set_title("BDD Frameworks by Perceived Importance")
ax.invert_yaxis()

# Save and show chart
plt.xlim(1, 5)
plt.savefig("b11.pdf", dpi=300, bbox_inches='tight', pad_inches=0) 
plt.tight_layout()
plt.show()