...
# Filter columns
col_name = "Which tool do you use to create locators?"
...
ax.set_title("Locator Tools by Perceived Importance")
ax.invert_yaxis()

# Save and show chart
plt.xlim(1, 5)
plt.savefig("b07.pdf", dpi=300, bbox_inches='tight', pad_inches=0) 
plt.tight_layout()
plt.show()