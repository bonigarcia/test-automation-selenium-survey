...
# Filter columns
col_name = "Which testing frameworks of the Selenium ecosystem do you use to create your automated tests? "
...
ax.set_title("Selenium E2E Testing Frameworks by Perceived Importance")
ax.invert_yaxis()

# Save and show chart
plt.xlim(1, 5)
plt.savefig("b10.pdf", dpi=300, bbox_inches='tight', pad_inches=0) 
plt.tight_layout()
plt.show()