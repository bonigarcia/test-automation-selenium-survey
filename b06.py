...
# Filter columns
col_name = "What locator strategy do you implement in your Selenium scripts?"
...
ax.set_title("Locator Strategy by Perceived Importance")
ax.invert_yaxis()

# Save and show chart
plt.xlim(1, 5)
plt.savefig("b06.pdf", dpi=300, bbox_inches='tight', pad_inches=0) 
plt.tight_layout()
plt.show()